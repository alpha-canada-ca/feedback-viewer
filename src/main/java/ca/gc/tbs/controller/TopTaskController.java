...
public class TopTaskController {
    ...
    public String[] taskListEN(HttpServletRequest request) {
        return new String[]{
                ...
                "Old Age Security (OAS) - Apply for Old Age Security",
                "Old Age Security (OAS) - View payment amounts",
                ...
                "Air Quality Health Index ratings",
                "Benefits for Indigenous people",
                "Apply for grants and incentives for your home",
                "Apply for wage subsidies or a hiring assistance program",
                "Apply to work and travel abroad with International Experience Canada (IEC)",
                "ArriveCAN - Make a customs and immigration declaration before flying into Canada",
                "Authorized Paid Representatives Portal",
                "Benefits for people with disabilities",
                "Benefits for survivors of deceased public servants",
                ...
                "Consumer or health product recalls and safety alerts",
                "Defence administrative orders and directives (DAOD)",
                "Disability tax credit",
                "Drones - where you can fly",
                "Drugs approved for use and sale in Canada",
                "Establish or expand a business in Canada as a foreign investor",
                "Family violence and how to get help",
                "Federal government response to a current emergency event",
                "File a corporate tax return",
                "File a Personal tax return",
                "File an employer information return (T4 Summary)",
                "Financial support to provinces and territories",
                "Find a drone flight school",
                "Find a job in the private sector",
                "Find information on loans and lines of credit",
                "Find out about Canadian wildfires",
                "Find prices for lumber, crude oil and other fuels",
                "Food labels",
                ...
                "Grants for technological innovation - Industrial Research Assistance Program (IRAP)",
                "GST/HST - File a return",
                "GST/HST - Get access code",
                "GST/HST - Open account",
                "Guaranteed Income Supplement (GIS)",
                "Hazardous materials in the workplace",
                "Hazardous properties of a human pathogen and how to work with it in a laboratory setting",
                "Health and safety in federal properties",
                "How Canada is managing pollution",
                "How to extend your stay in Canada",
                "Human rights in Canada",
                "Immunization and vaccination guidelines and practices",
                "Jobs in the military (Canadian Armed Forces)",
                "Key social determinants of health in Canada",
                "Learn about connected and automated vehicles",
                "Learn about fuel efficient driving",
                "Learn about shipping lithium batteries",
                "Learn about the histories and cultures of Indigenous Peoples",
                "Learn about zero-emission vehicles (electric, hybrid, hydrogen fuel cell)",
                "Learn how to bring your vehicle into Canada permanently",
                "Learn how to bring your vehicle into Canada temporarily (students, visitors)",
                "Learn how to commercially import a vehicle into Canada",
                "Learn how to drive a rental vehicle across the border from the U.S. to Canada",
                "Learn what I cannot bring on an airplane",
                "Major pollutants and toxic substances affecting the environment",
                "Make buildings and homes energy efficient",
                "Manage and report imported goods into Canada",
                "Marine conditions (tides and ocean water levels)",
                "Mental health support and how to get help",
                "Missions, operations, and deployments",
                "Natural health products licensed for use in Canada",
                "Official symbols of Canada",
                "Outbreaks of food and water-borne illnesses and diseases in Canada",
                "Pay issues (pay action requests, pay enquiry)",
                "Performance management program for employees",
                "Problematic use of drugs (such as opioids) and how to get help",
                "Producing and selling cannabis",
                "Public service pension calendar",
                "Qualifications, competencies and classifications for public service jobs",
                "Queen's regulations and orders (QR&O)",
                "Ranks in the military",
                "Read the statistics for vehicle collisions",
                "Reserves (part-time army, navy, air force)",
                "Safe cooking temperature for food",
                "Start a business",
                "Student jobs and internship programs",
                "Student jobs in the federal public service",
                "Symptoms or risks for a disease or condition",
                "Vaping and its risks",
                "View census data",
                "View or download T4 and other tax slips",
                "What to do following a death",
                "Working remotely and hybrid work"
        };
    }
    ...
    public String[] taskListFR(HttpServletRequest request) {
        return new String[]{
                ...
                "Mon dossier Service Canada – Voir les relevés d’emploi (RE)",
                ...
                "Sécurité de la Vieillesse – Voir le montant des paiements",
                ...
                "Trouver la date de paiement d’une pension",
                "Trouver un dossier de faillite et d’insolvabilité",
                ...
                "Accédez aux bulletins de cybersécurité",
                "Acheter des exemplaires des codes du bâtiment ou du matériel de référence certifié",
                "Acheter une maison",
                "Agriculture durable, technologies vertes et énergie renouvelable",
                "Aide aux travailleurs étrangers temporaires",
                "Améliorer votre cote de crédit",
                "Aperçu des pays (informations culturelles)",
                "Apprendre comment le Canada gère la pollution",
                ...
                "Calculer vos paiements par carte de crédit",
                "Calculer vos versements de retraite",
                "Calculer vos versements hypothécaires ou remboursements anticipés",
                "Changer d’adresse pour son permis d’armes à feu",
                "Changer mon adresse à l’Agence du revenu du Canada",
                "Combien faut-il pour une mise de fonds",
                "Commander votre dossier de crédit",
                ...
                "Communiquer avec un contrôleur des armes à feu",
                "Comparer les comptes bancaires canadiens",
                "Comprendre comment fonctionne la tarification de la pollution au Canada",
                "Comprendre l’indemnité de départ",
                "Compte sécurisé d'IRCC - enregistrer, connecter, aide",
                ...
                "Connaître les taux de l’impôt sur le revenu",
                "Conseils aux voyageurs et avertissements",
                "Constituer une entreprise en société",
                "Constituer une organisation à but non lucratif",
                "Construire, entretenir et immatriculer un aéronef",
                "Consulter le devis directeur national de la construction au Canada",
                "Consulter le discours du Trône",
                ...
                "Consulter les avis publics dans la Gazette du Canada",
                "Consulter les conventions fiscales du Canada",
                ...
                "Consulter les statistiques de l’industrie",
                "Consulter mes feuillets de renseignements T4",
                ...
                "Consulter une loi, un traité ou un règlement",
                "Consultez le Règlement de l'aviation canadien (RAC)",
                ...
                "Devenir bénévole pour un projet d’aide humanitaire",
                ...
                "Établir un budget",
                "Étudier au Canada – pour les non-Canadiens",
                ...
                "Exploitation d'aéroports et d'aérodromes",
                ...
                "Faire une recherche sur vos généalogie et histoire familiale",
                ...
                "Heure officielle à travers le Canada",
                "Immigrez dans le cadre d’Entrée express",
                "Immigrez en tant que candidat d’une province",
                "Incendies de forêt actuels et passés au Canada",
                "Joignez-vous aux cadets",
                "L'énergie renouvelable au Canada",
                "Le droit à l'éducation (développement international)",
                "Le droit à la santé et à la nutrition",
                "Les emplois civils à la Défense nationale",
                "Lire les biographies des astronautes canadiens",
                "Lire un rapport ou une publication",
                "Lire une convention collective de la fonction publique",
                ...
                "Obtenir un code d’accès pour la TPS/TVH",
                "Obtenir un formulaire ou un guide d’impôt",
                ...
                "Paix et sécurité",
                "Parrainez les membres de votre famille aux fins d’immigration au Canada",
                "Participer à des événements et activités du Bal de Neige",
                "Participer à la Journée nationale des peuples autochtones",
                "Participer au jour du Souvenir",
                "Participer aux célébrations de la fête du Canada",
                "Payez vos frais en ligne",
                "Piloter un aéronef",
                "Politique d'aide internationale féministe du Canada",
                "Politique étrangère et relations internationales du Canada",
                "Postulez pour un emploi dans les Forces",
                ...
                "Présenter une demande d’Allocation canadienne pour enfants (ACE)",
                ...
                "Présenter une demande de numéro d’assurance sociale (NAS)",
                ...
                "Présenter une demande de prestations pour Autochtones",
                "Présenter une demande de prêts et bourses",
                ...
                "Prévention, masques",
                "Produire une déclaration annuelle de revenus des sociétés",
                "Produire une déclaration de TPS/TVH",
                "Programme d'embauche pour la relance économique du Canada",
                "Projets d'aide internationale financés par le Canada",
                "Prolonger votre séjour au Canada",
                "Publications et guides",
                "Publier une offre d’emploi sur Guichet-Emplois",
                ...
                "Rechercher un organisme de bienfaisance",
                "Rechercher une espèce en péril au Canada",
                ...
                "Rendre une maison éconergétique",
                "Renouveler un passeport canadien",
                ...
                "S'inscrire en tant que Canadien vivant ou voyageant à l'extérieur du Canada",
                ...
                "Savoir si la vente d’un appareil médical est autorisée au Canada",
                "Se joindre à la GRC",
                ...
                "Se renseigner sur les symboles officiels du Canada",
                "Séismes actuels et passés au Canada",
                ...
                "Surveillance des niveaux d'eau et des inondations au Canada (intérieur)",
                ...
                "Trouver un brevet",
                "Trouver un emploi d’étudiant à la fonction publique fédérale",
                "Trouver un formulaire pour les avantages sociaux",
                "Trouver un logiciel de préparation de déclarations de revenus",
                "Trouver un ministère ou organisme",
                "Trouver un numéro de téléphone de l’Agence du revenu du Canada",
                "Trouver un stage d’apprentissage",
                ...
                "Trouver une marque de commerce",
                "Trouver une revue scientifique, technique ou médicale",
                "Trouver une société",
                "Trouvez des statistiques sur les collisions de véhicules",
                "Trouvez un centre de réception des demandes de visa",
                "Trouvez un emploi dans les Forces",
                "Trouvez un endroit où faire voler votre drone",
                "Trouvez un établissement d’enseignement désigné",
                ...
                "Utilisez le Portail des représentants autorisés rémunérés",
                ...
                "Vérifier si vous pouvez entrer au Canada",
                "Vérifiez l’état de sa demande",
                ...
                "Voir la caméra des aurores boréales",
                "Voir les données statistiques",
                "Vols d'embarquement à destination et à l'intérieur du Canada",
                "Voyager au Canada",
                "Voyages hors du Canada",
                "Indices de la cote air santé",
                "Prestations pour Autochtones",
                "Présentez des demandes de subvention et d’incitatifs pour votre maison",
                "Faire une demande de subvention salariale ou de programme d’aide à l’embauche",
                "Travailler et voyager à l'étranger avec Expérience internationale Canada (EIC) en tant que Canadien",
                "ArriveCAN - Soumettre votre déclaration de douane et d'immigration avant d'atterrir au Canada",
                "Portail des représentants autorisés rémunérés",
                "Prestations pour les personnes handicapées",
                "Prestations offertes aux survivants de fonctionnaires décédés",
                ...
                "Forêts canadiennes et leur préservation",
                "Cannabis (effets sur la santé, usage médical, légalisation)",
                "Organisme de bienfaisance (rechercher, crédit d'impôt)",
                "Conseils de santé aux voyageurs en vigueur pour un pays",
                "Vérifiez l’état de votre demande de passeport",
                "Paiement de l’incitatif à agir pour le climat (PIAC)",
                "Rappels et avis de sécurité sur les biens de consommation et les produits de santé",
                "Directives et ordonnances administratives de la défense (DOAD)",
                "Crédit d’impôt pour personnes handicapées",
                "Drones - où vous pouvez voler",
                "Déterminer si l’utilisation d’un médicament est autorisée au Canada",
                "Établir ou développer votre entreprise au Canada en tant qu’investisseur étranger",
                "Violence familiale et comment obtenir de l'aide",
                "La réponse du Canada lors de conflits, de crises et de catastrophes",
                "Produire une déclaration de revenus des sociétés",
                "Produire une déclaration de revenus personelle",
                "Remplir une déclaration de renseignements d’employeur (T4 Sommaire)",
                "Soutien financier aux provinces et aux territoires",
                "Trouvez une école de pilotage de drone",
                "Trouver un emploi dans le secteur privé",
                "Trouver de l’information sur les prêts et les marges de crédit",
                "Renseignez-vous sur les feux de forêt au Canada",
                "Trouvez les prix du bois d’œuvre, du pétrole brut et d’autres carburants",
                "Étiquettes de produits alimentaires",
                "Rappels et avis de sécurité sur les aliments",
                "Obtenez un certificat de pilote de drone",
                "Se procurer ou préparer une trousse d’urgence",
                "Acquérir de l’expérience de travail et de la formation",
                "Subventions pour l'innovation technologique - Programme d'aide à la recherche industrielle (PARI)",
                "TPS/TVH - Produire une déclaration",
                "TPS/TVH - Obtenir un code d'accès",
                "TPS/TVH - Ouvrir un compte",
                "Supplément de revenu garanti (SRG)",
                "Matières dangereuses utilisées au travail",
                "Propriétés dangereuses d'un agent pathogène humain et ses procédures de manipulation en laboratoire",
                "Santé et la sécurité dans les immeubles fédéraux",
                "Comment le Canada gère la pollution",
                "Prolonger votre séjour au Canada",
                "Droits de la personne au Canada",
                "Lignes directrices et pratiques pour l'immunisation et la vaccination",
                "Emplois dans le secteur militaire (Forces armées canadiennes)",
                "Principaux déterminants sociaux de la santé au Canada",
                "Renseignez-vous sur les véhicules connectés et automatisés",
                "Apprenez-en davantage sur la conduite écoénergétique",
                "Renseignez-vous sur l’expédition ou l’envoi de piles au lithium",
                "Se renseigner sur les histoires et les cultures des Autochtones",
                "Renseignez-vous sur les véhicules zéro émission (électriques, hybrides, à pile à hydrogène)",
                "Renseignez-vous sur la façon d’apporter votre véhicule au Canada en permanence",
                "Renseignez-vous sur la façon d’apporter votre véhicule au Canada temporairement (étudiants, visiteurs)",
                "Renseignez-vous sur l’importation commerciale de véhicules au Canada",
                "Renseignez-vous sur la façon de traverser la frontière des É.-U. au Canada en véhicule de location",
                "Déterminer ce que vous pouvez emporter en avion",
                "Principaux polluants et substances toxiques affectant l'environnement",
                "Rendre les bâtiments et les maisons plus écoénergétiques",
                "Gérer et déclarer les marchandises importées au Canada",
                "Conditions marines (marées et niveaux d'eau de l'océan)",
                "Soutien en santé mentale et comment obtenir de l'aide",
                "Missions, opérations et déploiements",
                "Produits de santé naturels dont l'utilisation est autorisée au Canada",
                "ymboles officiels du Canada",
                "Éclosions de maladies d'origine alimentaire et hydrique",
                "Problèmes de paye (demandes d'intervention de paye, demandes de renseignements au sujet de la paye)",
                "Programme de gestion du rendement pour les employés",
                "Usage problématique des drogues (comme les opioïdes) et comment obtenir de l'aide",
                "Production et vente de cannabis",
                "Calendrier des pensions de la fonction publique",
                "Drones - où vous pouvez voler",
                "Qualifications, compétences et classifications des emplois dans la fonction publique",
                "Ordonnances et règlements royaux",
                "Grades dans les forces armées",
                "Trouvez des statistiques sur les collisions de véhicules",
                "Réservistes (membres à temps partiel de l’Armée, de la Marine, de la Force aérienne)",
                "Température de cuisson sécuritaire pour les aliments",
                "Démarrer une entreprise",
                "Programmes d'emplois et de stages pour étudiants",
                "Emploi étudiant à la fonction publique fédérale",
                "Symptômes ou risques d'une maladie ou d'une affection",
                "Vapotage et ses riques",
                "Consulter les données du recensement",
                "Voir et télécharger les feuillets T4 et autres feuillets fiscaux",

...
public class UserService implements UserDetailsService {
    ...
    public static final String API_USER_ROLE = "API_USER";
    ...
    public void saveApiUser(User user) {
        user.setPassword(bCryptPasswordEncoder.encode(user.getPassword()));
        user.setDateCreated(DATE_FORMAT.format(new Date()));
        Role apiUserRole = roleRepository.findByRole(API_USER_ROLE);
        user.setRoles(new HashSet<>(Arrays.asList(apiUserRole)));
        userRepository.save(user);
    }

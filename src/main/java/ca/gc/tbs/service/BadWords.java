...
//            "static/badwords/threats_en.txt"
    ...
    public static void loadConfigs() {
        ...
        loadGoogleConfigs("https://docs.google.com/spreadsheets/d/1hIEi2YG3ydav1E06Bzf2mQbGZ12kh2fe4ISgLg_UBuM/export?format=csv");
    ...
    private static void loadGoogleConfigs(String googleSheetUrl) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new URL(googleSheetUrl).openConnection().getInputStream()))) {
            String line;

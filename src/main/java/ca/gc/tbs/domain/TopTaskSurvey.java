...
public class TopTaskSurvey {
    ...
    public TopTaskSurvey(String id, String dateTime, String timeStamp, String processedDate, String surveyReferrer,
                         String language, String device, String screener, String dept, String theme, String themeOther,
                         String grouping, String task, String taskOther, String taskSatisfaction, String taskEase,
                         String taskCompletion, String taskImprove, String taskImproveComment, String taskWhyNot,

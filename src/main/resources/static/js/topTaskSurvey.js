$(document).ready(function () {
  ...
  var table = new DataTable("#topTaskTable", {
    ...
    columns: [
      { data: 'dateTime', title: isFrench ? 'Date' : 'Date', visible: true, width: "14%", className: "dt-left" },
      ...
      { data: 'task', title: isFrench ? 'Tâche' : 'Task', visible: true, width: "36%" },
      ...
      { data: 'taskImproveComment', title: isFrench ? 'Améliorer la tâche - commentaire' : 'Task Improve Comment', visible: true, width: "25%" },
      { data: 'taskWhyNot', title: isFrench ? 'Pourquoi pas' : 'Task Why Not', visible: false },
      { data: 'taskWhyNotComment', title: isFrench ? 'Tâche non complétée - commentaire' : 'Task Why Not Comment', visible: true, width: "25%"},
